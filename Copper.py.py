...
if selected == "Predictions":
    ...
    try:
        with tab1:
            st.markdown("### :orange[Predicting Selling Price (Regression Task) (Accuracy: 92%)]")
            with st.form("form1"):
                ...
                with col3:
                    ...
                    if submit_button is not None:
                        with open(r"D:\My files\Nagammai\Guvi\MDE86\code\model.pkl", 'rb') as file:
                            loaded_model = pickle.load(file)
                        with open(r'D:\My files\Nagammai\Guvi\MDE86\code\scaler.pkl', 'rb') as f:
                            scaler_loaded = pickle.load(f)
                        with open(r"D:\My files\Nagammai\Guvi\MDE86\code\t.pkl", 'rb') as f:
                            t_loaded = pickle.load(f)
                        with open(r"D:\My files\Nagammai\Guvi\MDE86\code\s.pkl", 'rb') as f:
    ...
    try:
        with tab2:
            st.markdown("### :orange[Predicting Status (Classification Task) (Accuracy: 88%)]")
            with st.form("form2"):
                ...
                with col3:
                    ...
                    if csubmit_button is not None:
                        if cquantity_tons and cselling:
                            with open(r"D:\My files\Nagammai\Guvi\MDE86\code\cmodel.pkl", 'rb') as file:
                                cloaded_model = pickle.load(file)
                            with open(r'D:\My files\Nagammai\Guvi\MDE86\code\cscaler.pkl', 'rb') as f:
                                cscaler_loaded = pickle.load(f)
                            with open(r"D:\My files\Nagammai\Guvi\MDE86\code\ct.pkl", 'rb') as f:
